    ...
    <div id = "vue_jurisdiction" name = "vue_jurisdiction">
        <div id = 'top-wrapper'>
            ...
            <div id = 'module-navigation-box'>
                <div class = 'module-navigation-title'> Módulo 1</div>
                <div class = 'module-navigation'> Introdução ao javascript</div>
                <div class = 'module-navigation'> Declaração de variáveis</div>
                <div class = 'module-navigation'> Estruturas condicionais</div>
                <div class = 'module-navigation'> Estruturas de loop</div>
                <div class = 'module-navigation'> Validação de formulários</div>
                <div class = 'module-navigation'> Dicas de segurança</div>
            </div>
        </div>
